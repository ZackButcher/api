...
type MeshConfig struct {
	...
	// Enable Report calls by Gateways as if they're servers, in addition to their usual
	// usual reporting as a client. This results in two Report calls made at the gateway:
	// the first, `unknown` into `gateway` and the second (normal) `gateway` into
	// `service`.
	//
	// This is useful for generating more metrics about the traffic your gateways are
	// receiving, useful for deployments where the gateway acts as cluster ingress.
	EnableGatewayServerReports bool `protobuf:"varint,37,opt,name=enable_gateway_server_reports,json=enableGatewayServerReports,proto3" json:"enable_gateway_server_reports,omitempty"`
...
func (m *MeshConfig) GetEnableGatewayServerReports() bool {
	if m != nil {
		return m.EnableGatewayServerReports
	}
	return false
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnableGatewayServerReports {
		dAtA[i] = 0xa8
		i++
		dAtA[i] = 0x2
		i++
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 37:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableGatewayServerReports", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableGatewayServerReports = bool(v != 0)
		default:
			iNdEx = preIndex
