...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_gateway_server_mixer', full_name='istio.mesh.v1alpha1.MeshConfig.enable_gateway_server_mixer', index=5,
